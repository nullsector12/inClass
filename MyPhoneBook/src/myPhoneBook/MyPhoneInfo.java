...
public class MyPhoneInfo {
	 ...
	 public void PhoneInfor(){} // default 메서드 생성
	 
	 public void PhoneInfor (String name, String phoneNumber, String birthDay){
	  name = this.name;
	  phoneNumber = this.phoneNumber;
	  birthDay = this.birthDay;
	 }
	 
	 public void PhoneInfor (String name, String phoneNumber){
	  name = this.name;
	  phoneNumber = this.phoneNumber;
	  birthDay = this.birthDay;
	 }
	 ...
	 public static void main(String[] args) {
	  ...
	  while(true) { // 선택에 따라 프로그램 무한 반복 = while문
	   ...
	   MyPhoneInfo save = new MyPhoneInfo(); // 사용자가 입력한 정보 저장
	   save.showBook(); // 입력된 정보 출력 메서드 호출
